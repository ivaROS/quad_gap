    ...
    void TimeKeeper::startTimer(const int & planningStepIdx)
    {
        switch (planningStepIdx)
        {
            ...
            case TRAJ_COMP:
                ...
                break;
            case COLL_CHECK:
                collisionCheckStartTime = std::chrono::steady_clock::now();
                break;
            case PLAN:
    ...
    void TimeKeeper::stopTimer(const int & planningStepIdx)
    {
        ...
        switch (planningStepIdx)
        {
            ...
            case TRAJ_COMP:
                ...
                break;
            case COLL_CHECK:
                collisionCheckEndTime = std::chrono::steady_clock::now();
                currTimeTaken = timeTaken(collisionCheckStartTime, collisionCheckEndTime);  
                break;
            case PLAN:
    ...
    float TimeKeeper::computeAverageTimeTaken(const float & currTimeTaken, const int & planningStepIdx)
    {
        ...
        switch (planningStepIdx)
        {
            ...
            case TRAJ_COMP:
                ...
                break;    
            case COLL_CHECK:
                totalCollisionCheckTimeTaken += currTimeTaken;
                collisionCheckCalls++;
                averageTimeTaken = (totalCollisionCheckTimeTaken / collisionCheckCalls);
                break;   
            case PLAN:
