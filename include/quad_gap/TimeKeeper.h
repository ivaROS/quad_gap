    ...
    class TimeKeeper
    {
        ...
        private:
            ...
            */
            ...
            std::chrono::steady_clock::time_point collisionCheckStartTime; /**< Start time for collision checking */
            std::chrono::steady_clock::time_point collisionCheckEndTime; /**< End time for collision checking */
            float totalCollisionCheckTimeTaken = 0.0f; /**< Total time taken for collision checking */
            int collisionCheckCalls = 0; /**< Total number of calls for collision checking */
